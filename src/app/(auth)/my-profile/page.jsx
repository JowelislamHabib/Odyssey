      ...
      <div className="container mx-auto space-y-6">
          ...
          <Card.Content className="p-6 md:p-10 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left space-y-2">
              <div className="flex flex-col md:flex-row md:items-center gap-3">
                ...
                <Chip
                  variant="flat"
                  className="bg-sky-500 text-white font-black uppercase tracking-[0.2em] text-[9px] h-5 rounded-md self-center md:self-auto"
                >
                  Verified Buyer
                </Chip>
              </div>
              <p className="text-stone-500 font-medium flex items-center justify-center md:justify-start gap-2">
                <IoLocationOutline className="text-sky-500" /> New York, USA
              </p>
            </div>
            <UserUpdate />
          </Card.Content>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <div className="md:col-span-5 space-y-6">
                ...
                {menuItems.map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="p-2 bg-stone-100 rounded-lg text-stone-900 group-hover:bg-sky-100 group-hover:text-sky-600 transition-colors">
                        {item.icon}
                      </div>
            ...
            <Card className="border-none shadow-xl rounded-xl bg-sky-500 p-8 text-white relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16 blur-2xl" />
              <div className="relative z-10 space-y-4">
                <h3 className="text-xl font-serif italic">Solis Rewards</h3>
                <div>
                  <p className="text-4xl font-bold">450</p>
                  <p className="text-sky-100 text-xs font-black uppercase tracking-widest">
                    Available Points
                  </p>
                </div>
