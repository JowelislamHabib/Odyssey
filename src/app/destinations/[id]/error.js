    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-white px-6">
      <div className="container mx-auto max-w-2xl text-center">
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            onClick={() => reset()}
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 bg-[#0088d1] text-white rounded-xl font-black uppercase text-xs tracking-widest hover:bg-[#0077b6] transition-all shadow-lg shadow-sky-100"
          >
            <LuRefreshCw size={18} />
            Try Again
          </button>
          ...
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 bg-white border border-slate-200 text-slate-900 rounded-xl font-black uppercase text-xs tracking-widest hover:bg-slate-50 transition-all"
          >
            <LuHouse size={18} />
            Go To Home
          </button>
