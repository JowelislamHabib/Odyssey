  ...
  return (
    <Modal isOpen={isOpen} onOpenChange={onOpenChange}>
      {customTrigger ? (
        ...
        <Button
          className="bg-stone-900 text-stone-50 font-bold px-8 h-12 rounded-xl hover:bg-sky-500 transition-all active:scale-95 text-xs uppercase tracking-widest"
                  ...
                  >
                    ...
                    <div className="relative flex items-center">
                      ...
                      <Input
                        ...
                        className="w-full pl-11 pr-4 py-4 bg-stone-50 border border-stone-200 rounded-xl focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 transition-all"
                      />
                    </div>
                    <FieldError className="text-red-500 text-[10px] font-bold uppercase ml-1" />
                  </TextField>
