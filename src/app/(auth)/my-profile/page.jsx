        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <aside className="w-full lg:w-80 space-y-4">
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex items-center gap-4">
              ...
              <div>
                <h2 className="font-black text-slate-900 uppercase tracking-tight leading-none">
                  {user?.name}
                </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {stats.map((stat, i) => (
                ...
                >
                  ...
                  <div className="size-12 bg-slate-50 text-slate-400 rounded-xl flex items-center justify-center text-xl group-hover:bg-sky-50 group-hover:text-sky-600 transition-all">
                    {stat.icon}
                  </div>
                </div>
              ))}
